...
This Bash script demonstrates arithmetic operators, comparison operators, logical operators, and decision-making using `if`, `elif`, and `else`.
...
- Arithmetic operations such as addition, subtraction, and percentage calculation.
- Conditional logic using `if`, `elif`, and `else`.
- Comparison operators like `-eq`, `-ne`, `-gt`, `-lt`, `-ge`, and `-le`.
- Logical operators like `&&`, `||`, and `!`.

## Example usage

Run the script and enter values when prompted to see salary calculations and employee evaluation results.
